...
import { UpdateHaircutController } from './controllers/haircut/UpdateHaircutControlller';
import { CheckSubscriptionController } from './controllers/haircut/CheckSubscriptionController';
import { CountHaircutsController } from './controllers/haircut/CountHaircutsController';
import { DetailHaircutController } from './controllers/haircut/DetailHaircutController';
import { NewScheduleController } from './controllers/schedule/NewScheduleController';
import { ListScheduleController } from './controllers/schedule/ListScheduleController';
import { FinishScheduleControllter } from './controllers/schedule/FinishScheduleControllter';
...
router.delete('/schedule', isAuthenticated, new FinishScheduleControllter().handle)
